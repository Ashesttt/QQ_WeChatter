...
async def qrcode_command_handler(to: Union[str, SendTo], message: str = "") -> None:
    # 获取二维码
    try:
...
def _save_qrcode(img, path: str) -> None:
    """
    保存二维码到指定路径
    """
...
def _get_qrcode_url(data: str) -> str:
    """
    获取二维码的url
    """
